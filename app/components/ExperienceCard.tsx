  ...
  return (
    <li className='mb-12'>
      <div className='group relative grid pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50'>
        ...
        <header
          className='z-10 mb-2 mt-1 text-[11px] font-semibold uppercase tracking-wide text-[#666666] sm:col-span-2'
          aria-label={date}
        >
          {date}
        </header>
        <div className='z-10 sm:col-span-6'>
          <h3 className='font-medium leading-snug text-slate-200'>
            <div>
              <a
                className='inline-flex items-baseline font-medium leading-tight hover:text-purple-500 focus-visible:text-purple-500 group/link text-base'
                href={""}
                target='_blank'
